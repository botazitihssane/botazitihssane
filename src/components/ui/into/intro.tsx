    ...
    return (
        <>
            <div className="flex mt-40">
                <div className="flex-1 items-center justify-start m-10">
                    <div className="flex flex-col items-start justify-center min-h-[0]">
                        <>
                            <div
                            ...
                            <div
                                ...
                                <p>I&apos;m a <span className="text-sky-500">software engineering intern </span>deeply
                                    ...
                                    particularly in <span className="text-pink-700"> Java</span>,<span
                                        ...
                                        className="text-pink-700">Angular</span>. I&apos;m driven by the excitement of
                                    building robust applications that seamlessly integrate frontend and backend
                                    technologies. Additionally, I&apos;m enthusiastic about exploring the potential
                                    of<span
                                        className="text-sky-500"> blockchain technology </span> to revolutionize various
                                    industries. Let&apos;s collaborate and create impactful solutions together!</p>
                            </div>
                            <div
                                className="text-base sm:text-base md:text-base lg:text-base font-normal text-justify mt-14 text-slate-500 mb-14">
                                <Button>
                                    Download resume
                                </Button>
                            </div>
