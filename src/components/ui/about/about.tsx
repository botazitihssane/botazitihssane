            ...
            <div className="flex">
                <div className="flex-1 items-center justify-start">
                    <div className="flex flex-col items-start justify-center h-[800px] ">
                        <>
                            <div
                                className="text-base sm:text-xl md:text-2xl flex justify-center items-center lg:text-2xl font-semibold text-center mt-6 text-blue-500 italic">
                                <div className="h-2 w-6 border-b border-blue-500 italic mr-0.5 "></div>
                                <p> Hello ! </p>
                            </div>
                            <div
                            ...
                            <div
                                ...
                                <p>I&apos;m a <span className="text-blue-500">software engineering intern </span>deeply
                                    passionate about <span className="text-blue-500">full-stack development</span>,
                                    ...
                                    of<span className="text-blue-500"> blockchain technology </span> to
